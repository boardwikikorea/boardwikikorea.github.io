import{w as s,s as c}from"./index-CDI2jjIL.js";function w(e){return Array.isArray(e)?e[0]??null:e}function _(e){const r=w(e.profile);return{id:e.id,crewId:e.crew_id,userId:e.user_id,status:e.status,message:e.message,reviewedBy:e.reviewed_by,reviewedAt:e.reviewed_at,createdAt:e.created_at,updatedAt:e.updated_at,nickname:(r==null?void 0:r.nickname)??null,fullName:(r==null?void 0:r.full_name)??null,provider:(r==null?void 0:r.provider)??"unknown"}}const o=`
  id,
  crew_id,
  user_id,
  status,
