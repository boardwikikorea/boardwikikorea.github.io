import{w as n,s as r}from"./index-SF3eVCzb.js";async function d(a,t=[]){return n(async()=>{const{data:e,error:i}=await r.rpc("apply_event",{p_event_id:a,p_options:t.map(s=>({option_id:s.optionId,music_text:s.musicText??null}))});if(i)throw i;return{registrationId:e}})}async function _(){return n(async()=>{const{data:a,error:t}=await r.from("view_my_event_registrations").select(`
        registration_id,
        registration_state,
        registered_at,
