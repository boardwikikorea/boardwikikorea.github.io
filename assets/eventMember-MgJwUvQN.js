import{w as o,s}from"./index-CHs91-cc.js";function c(e){return Array.isArray(e)?e[0]??null:e}async function d(e){return o(async()=>{const{data:n,error:r}=await s.from("event_member").select(`
        id,
        event_id,
        user_id,
        role,
