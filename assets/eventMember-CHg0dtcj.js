import{w as o,d as s}from"./index-CtG5Mkl6.js";function c(e){return Array.isArray(e)?e[0]??null:e}async function m(e){return o(async()=>{const{data:n,error:r}=await s.from("event_member").select(`
        id,
        event_id,
        user_id,
        role,
