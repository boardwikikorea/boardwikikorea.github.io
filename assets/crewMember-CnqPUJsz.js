import{w as _,s as c}from"./index-Cm0KFC5-.js";function u(e){return Array.isArray(e)?e[0]??null:e}function o(e){return Array.isArray(e)?e[0]??null:e}async function w(e){return _(async()=>{const{data:a,error:t}=await c.from("crew_member").select(`
        id,
        crew_id,
        user_id,
        role,
