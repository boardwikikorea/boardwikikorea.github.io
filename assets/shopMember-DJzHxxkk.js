import{w as i,s as o}from"./index-BOYeQM9X.js";function c(t){return Array.isArray(t)?t[0]??null:t}function u(t){if(!t)return 0;const e=new Date(t).getTime();return Number.isFinite(e)?e:0}async function h(){return i(async()=>{const{data:t,error:e}=await o.from("shop_info").select(`
      id,
      instagram,
      homepage,
      blog,
