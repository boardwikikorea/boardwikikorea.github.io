import{w as s,d as _}from"./index-CsuIugsD.js";function A(e){return Array.isArray(e)?e[0]??null:e}function C(e){return Array.isArray(e)?e[0]??null:e}async function k(e){return s(async()=>{const{data:n,error:r}=await _.from("crew_member").select(`
        id,
        crew_id,
        user_id,
        role,
