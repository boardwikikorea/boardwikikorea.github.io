import{w as i,s as d}from"./index-jke8csM2.js";function m(n){return Array.isArray(n)?n[0]??null:n}function u(n){if(!n)return 0;const e=new Date(n).getTime();return Number.isFinite(e)?e:0}async function _(){return i(async()=>{const{data:n,error:e}=await d.from("shop_info").select(`
      id,
      instagram,
      homepage,
      blog,
