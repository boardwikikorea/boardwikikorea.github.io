import{w as d,s}from"./index-DTMlD39w.js";function m(e){return Array.isArray(e)?e[0]??null:e}async function c(e){return d(async()=>{const{data:n,error:r}=await s.from("event_admin_member").select(`
        id,
        event_id,
        user_id,
        role,
