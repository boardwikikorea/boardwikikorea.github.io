import{w as a,s as i}from"./index-DqylHEB0.js";function c(e){return Array.isArray(e)?e[0]??null:e}async function u(e){return a(async()=>{const{data:t,error:r}=await i.from("spot_member").select(`
        id,
        spot_id,
        user_id,
        role,
